--device
--click
insert into "FT_DB_DEV"."AGGREGATIONS"."AGENT_DEVICE_PLACEMENT_EVENT_M05"
  (
    activity_date,
    idbusiness_entity,
    idcampaign,
...
Select
    ...
    a.IAB_FLAG
From
    "FT_DB_DEV"."AGGREGATIONS"."AGENT_DEVICE_PLACEMENT_EVENT_M05" a
Left join
    "FT_DB_DEV"."MASTER_AGGREGATIONS"."AGENT_DEVICE_PLACEMENT_EVENT_M05" ma 
