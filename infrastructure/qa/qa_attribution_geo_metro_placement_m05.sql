...
From
    "FT_DB_DEV"."AGGREGATIONS"."ATTRIBUTION_GEO_METRO_PLACEMENT_M05" as a
Left join
    "FT_DB_DEV"."MASTER_AGGREGATIONS"."ATTRIBUTION_GEO_METRO_PLACEMENT_M05" as ma
    ...
    And a.METRO_CODE = ma.METRO_CODE
